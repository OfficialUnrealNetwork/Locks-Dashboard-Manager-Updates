...
const assetCatalogCache = new Map();
export function generateAssetCatalogForIcon(inputPath) {
...
async function compileAssetCatalogForIcon(inputPath) {
    ...
    const versionInfo = plist.parse(acToolVersionOutput);
    if (!versionInfo ||
